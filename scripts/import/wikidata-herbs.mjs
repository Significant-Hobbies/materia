...
const HERBS = [
  [
    ...
    'The leaves of Camellia sinensis, rich in catechin antioxidants.',
  ],
  [
    'Rosemary',
    'Salvia rosmarinus',
    ['carnosic-acid'],
    'An aromatic culinary herb of the mint family.',
  ],
  [
    'Oregano',
    'Origanum vulgare',
    ['carvacrol'],
    'A pungent culinary and medicinal mint-family herb.',
  ],
  [
    'Thyme',
    'Thymus vulgaris',
    ['thymol'],
    'An aromatic culinary herb traditionally used for coughs.',
  ],
  [
    'Clove',
    'Syzygium aromaticum',
    ['eugenol'],
    'The dried flower buds of the clove tree, traditionally used for toothache.',
  ],
  [
    'Licorice',
    'Glycyrrhiza glabra',
    ['glycyrrhizin'],
    'The sweet root of Glycyrrhiza glabra, long used in herbal medicine.',
  ],
  [
    'Chinese skullcap',
    'Scutellaria baicalensis',
    ['baicalin'],
    'A root used in traditional Chinese medicine.',
  ],
  [
    'Fennel',
    'Foeniculum vulgare',
    ['anethole'],
    'An anise-flavoured culinary herb traditionally used for digestion.',
  ],
  [
    'Black pepper',
    'Piper nigrum',
    ['piperine'],
    'The common spice, whose piperine can enhance absorption of other compounds.',
  ],
  [
    'Eucalyptus',
    'Eucalyptus globulus',
    ['eucalyptol'],
    'A tree whose leaf oil is traditionally inhaled for congestion.',
  ],
  [
    'Rhodiola',
    'Rhodiola rosea',
    [],
    'An adaptogenic root traditionally used for fatigue and stress.',
  ],
  ...
  [
    ...
    'Ocimum tenuiflorum',
    [],
    'Also called tulsi; an Ayurvedic herb used as an adaptogen.',
  ],
  [
    'Fenugreek',
    'Trigonella foenum-graecum',
    [],
    'A seed used as a culinary spice and traditional remedy.',
  ],
  [
    'Saw palmetto',
    'Serenoa repens',
    [],
    'A palm-berry extract traditionally used for prostate symptoms.',
  ],
  ...
  [
    ...
    [],
    'A climbing plant traditionally used for anxiety and sleep.',
  ],
  [
    'Horse chestnut',
    'Aesculus hippocastanum',
    [],
    'A seed extract traditionally used for leg-vein symptoms.',
  ],
  [
    'Gotu kola',
    'Centella asiatica',
    [],
    'An Ayurvedic and TCM herb used for wounds and circulation.',
  ],
  ...
  [
    ...
    [],
    'A root used in traditional Chinese medicine as a tonic.',
  ],
  [
    'Dandelion',
    'Taraxacum officinale',
    [],
    'A common plant whose leaf and root are used traditionally as a diuretic and digestive.',
  ],
  [
    'Marshmallow root',
    'Althaea officinalis',
    [],
    'A mucilage-rich root traditionally used to soothe throat and gut.',
  ],
  [
    'Schisandra',
    'Schisandra chinensis',
    [],
    'A berry used in traditional Chinese medicine as an adaptogen.',
  ],
  ...
  [
    ...
    'Uncaria tomentosa',
    [],
    'An Amazonian vine bark traditionally used for inflammation.',
  ],
];
  ...
  try {
    ...
    const res = await fetch(url, {
      headers: {
        ...
        'User-Agent': 'materia-importer/1.0 (research; contact via repo)',
      },
    });
...
for (const [common, scientific, compounds, summary] of HERBS) {
  ...
  console.log(
    `  ✓ ${common} (${scientific})${q ? ` — ${q}` : ' — no QID, search link'}${compounds.length ? ` · ${compounds.join(', ')}` : ''}`
  );
  written++;
}
